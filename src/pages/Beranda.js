...
function Beranda(props) {
    ...
    <div class="mt-20 relative mx-auto max-w-md rounded-lg bg-gradient-to-tr from-pink-300 to-blue-300 p-0.5 shadow-lg">
    ...
    <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Paket Rakyat 1</h5>
<div class="flex items-baseline text-gray-900 dark:text-white">
<span class="text-3xl font-semibold">Rp.</span>
<span class="text-5xl font-extrabold tracking-tight">{props.satu}</span>
...
<span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Kecepatan Internet Up to 10mbps Unlimited</span>
</li>
<li class="flex">
<svg class="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
<path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
...
<span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Optimal 3-4 Perangkat</span>
</li>
